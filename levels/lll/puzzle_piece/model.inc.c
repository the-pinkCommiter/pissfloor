...
const Gfx lll_seg7_dl_0701A538[] = {
    gsSPDisplayList(lll_seg7_dl_0701A2F0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, lll_seg7_texture_0700D800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(lll_seg7_dl_0701A338),
    gsSPEndDisplayList(),
...
const Gfx lll_seg7_dl_0701A568[] = {
    gsSPDisplayList(lll_seg7_dl_0701A2F0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, lll_seg7_texture_0700E000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(lll_seg7_dl_0701A338),
    gsSPEndDisplayList(),
...
const Gfx lll_seg7_dl_0701A598[] = {
    gsSPDisplayList(lll_seg7_dl_0701A2F0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, lll_seg7_texture_0700E800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(lll_seg7_dl_0701A338),
    gsSPEndDisplayList(),
...
const Gfx lll_seg7_dl_0701A5C8[] = {
    gsSPDisplayList(lll_seg7_dl_0701A2F0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, lll_seg7_texture_0700F000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(lll_seg7_dl_0701A338),
    gsSPEndDisplayList(),
...
const Gfx lll_seg7_dl_0701A5F8[] = {
    gsSPDisplayList(lll_seg7_dl_0701A2F0),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, lll_seg7_texture_0700F800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(lll_seg7_dl_0701A338),
    gsSPEndDisplayList(),
